...
def fetch_data(symbol):
    try:
        ...
        print(f"Fetched data for {symbol}: {overview}")
        return overview
...
def home():
    ...
    return send_from_directory(os.getcwd(), 'analyzer.html')

@app.route('/analyzer')
def analyzer():
    print("Analyzer route accessed")
    return send_from_directory(os.getcwd(), 'analyzer.html')
...
def get_ratios():
    ...
    print(f"Returning ratios: {ratios}")
